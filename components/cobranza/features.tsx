...
import { Mail, BarChart3, Clock, Zap } from "lucide-react"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium text-primary">{p.featuresEyebrow}</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground">
            {p.featuresHeading}{" "}
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              {p.featuresHeadingHighlight}
            </span>
          </h2>
          <p className="mt-5 text-lg text-muted-foreground text-pretty">{p.featuresSubheading}</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 group">
              <div className="relative h-full rounded-3xl bg-gradient-to-br from-card via-card to-primary/5 border border-border p-8 overflow-hidden hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl font-bold text-foreground mb-3">{p.feature1Title}</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">{p.feature1Desc}</p>
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted/50 border border-border/50">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-foreground">{p.feature1Sequence}</p>
                      <p className="text-xs text-muted-foreground">{p.feature1SequenceDesc}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 group">
              <div className="relative h-full rounded-3xl bg-gradient-to-br from-card via-card to-accent/5 border border-border p-8 overflow-hidden hover:border-accent/30 transition-all duration-500 hover:shadow-2xl hover:shadow-accent/10">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-3">{p.feature2Title}</h3>
                  <p className="text-muted-foreground leading-relaxed mb-6">{p.feature2Desc}</p>
            ...
            <div className="lg:col-span-4 group">
              <div className="relative h-full rounded-3xl bg-gradient-to-br from-card to-secondary/50 border border-border p-7 overflow-hidden hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">{p.feature3Title}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed mb-5">{p.feature3Desc}</p>
                <div className="space-y-3">
                  {p.trackingSteps.map((step, i) => (
