...
export function NexusPricing() {
  return (
    <section id="precio" className="py-24 sm:py-32 relative border-y border-border bg-card">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold uppercase tracking-widest text-primary">Precio Único</p>
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            Todo incluido en un solo plan. Sin sorpresas, sin costos adicionales.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-lg">
          <div className="relative rounded-3xl border-2 border-primary bg-card p-8 lg:p-12 shadow-2xl shadow-primary/10">
            ...
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-foreground">NEXUS Pro</h3>
              <p className="mt-2 text-muted-foreground">Todo lo que necesitas para tu negocio</p>
            ...
            <div className="mt-10 border-t border-border pt-10">
              <h4 className="text-sm font-semibold text-foreground mb-6">Todo incluido:</h4>
