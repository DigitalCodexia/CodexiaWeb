...
const jsonLd = {
  ...
  areaServed: [
    ...
    { '@type': 'AdministrativeArea', name: 'Provincia de Panamá' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Panamá Oeste' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Colón' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Chiriquí' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Coclé' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Herrera' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Los Santos' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Veraguas' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Bocas del Toro' },
    { '@type': 'AdministrativeArea', name: 'Provincia de Darién' },
  ],
  knowsAbout: [
    'Desarrollo Web',
    'E-commerce',
